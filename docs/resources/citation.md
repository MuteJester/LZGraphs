...
LZGraphs is released under the MIT License. See the [LICENSE](https://github.com/MuteJester/LZGraphs/blob/master/LICENSE) file for details.
...
- GitHub: [MuteJester/LZGraphs](https://github.com/MuteJester/LZGraphs)
